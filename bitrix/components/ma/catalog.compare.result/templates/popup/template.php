...
<div class="b-added-item">
	<div class="b-added-item_title h2">
		<?=GetMessage("MA_CATALOG_COMPARE_ADD")?>
	</div>
	<div class="b-added-item_holder">
		...
		<div class="b-added-item_text">
			...
			<div class="b-added-item_info">
				<?=GetMessage("MA_CATALOG_COMPARE_COUNT")?> <?=count($arResult["ITEMS"])?> <?=getWordEnding(count($arResult["ITEMS"]), array('товар', 'товара', 'товаров'))?>
			</div>
			<div class="b-added-item_buttons">
				<a href="<?=$arParams['COMPARE_URL']?>" class="g-button"><?=GetMessage("MA_CATALOG_COMPARE_GET")?></a>
				<a href="javascript:void(0)" class="g-close arcticmodal-close"><?=GetMessage("MA_CATALOG_COMPARE_CONTINUE")?></a>
			</div>
		</div>
	</div>
</div>