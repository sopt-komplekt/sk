...
/*
	Стили для построение сетки со списком разделов в сайдбаре (в виде меню) находятся в шаблоне catalog.section.list -> tree
*/
...
<? if (($arParams['SHOW_SECTION_LIST'] == "Y" && $HIDE_INNER_SECTION_LIST !== true) || ($arParams['USE_FILTER'] == "Y" && $HIDE_ELEMENT != "Y")): ?>

	<? $APPLICATION->SetAdditionalCSS($templateFolder."/css/sidebar.css"); ?>
	<? echo $HIDE_ELEMENT != "Y" ? '<div class="l-catalog-sidebar">' : '' ;?>
