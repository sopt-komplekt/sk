...
{
	$APPLICATION->AddHeadScript('/bitrix/components/ma/carousel/carousel.js');
}
if($arParams['USE_FANCYBOX'] == 'Y')
{
	$APPLICATION->AddHeadScript('/bitrix/components/ma/carousel/fancybox2/jquery.fancybox.pack.js');
	$APPLICATION->SetAdditionalCSS('/bitrix/components/ma/carousel/fancybox2/jquery.fancybox.css');	
}
