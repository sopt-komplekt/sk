...
<div class="b-products-table">
	...
	?>
		<div class="b-products-table__item b-sebi-<?=$arItem['ID']?> _b-csi-<?=$arItem['ID']?> jsProductTable" id="<?=$strMainID;?>">

			<div class="b-products-table__picture">
				<a class="b-products-table__picture-img"  href="<?=$arItem['DETAIL_PAGE_URL']; ?>" title="<?=$imgTitle;?>" style="background-image: url('<? echo $arItem['PREVIEW_PICTURE']['SRC'] ? $arItem['PREVIEW_PICTURE']['SRC'] : $templateFolder.'/images/no_photo.png'?>')" id="<? echo $arItemIDs['PICT']; ?>"></a>
			...
			<div class="b-products-table__info">
				...
				<div class="b-products-table__title">
					<a href="<?=$arItem['DETAIL_PAGE_URL']; ?>"><span><?=$productTitle;?></span></a>
				</div>
				...
				<? if (!isset($arItem['OFFERS']) || empty($arItem['OFFERS'])): ?>
					...
					<div class="b-products-table__actions">
						...
						<? if($arItem['CAN_BUY']): ?>
							...
							*/ ?>
							<a class="b-products-table__button b-products-table__basket g-button g-ajax-data" href="<?=$arItem["ADD_TO_BASKET_URL"]?>" id="<?=$arItemIDs['BUY_LINK']; ?>" rel="nofollow">
								<? echo $arParams['ADD_TO_BASKET_ACTION'] == 'BUY' ? GetMessage('CT_BCS_TPL_MESS_BTN_BUY') : GetMessage('CT_BCS_TPL_MESS_BTN_ADD_TO_BASKET');?>
							</a>
						<? else: ?>
...
<? if($arResult['DESCRIPTION'] && $arParams['ELEMENT_SIMILAR_DISPLAY'] != 'Y'): ?>
	<div class="b-products-table_description">
