...
$MESS["IBLOCK_FAVORITE"] = "Избранные товары";
...
$MESS["CP_BCS_DISPLAY_COMPARE"] = "Использовать сравнение товаров";
$MESS["CP_BCS_DISPLAY_FAVORITE"] = "Использовать избранные товары";
...
$MESS['SET_CANONICAL_URL'] = 'Устанавливать канонический URL для списка элементов';
$MESS['SET_CANONICAL_URL_TIP'] = 'Включать только при наличии пагинации. Для корректной работы необходимо в поле "Правило для обработки" раздела "Шаблоны ссылок" указать URL страницы сайта на которой размещен компонент';
?>