...
<div id="basket_items_list">
	<div class="b-basket_table-holder">
				...
				?>
					<tr id="<?=$arItem["ID"]?>">
						...
						foreach ($arResult["GRID"]["HEADERS"] as $id => $arHeader):
							...
							?>
								<td class="itemphoto">
									<div class="b-basket_table_photo-container">
										<?
										...
										<?if (strlen($arItem["DETAIL_PAGE_URL"]) > 0):?><a href="<?=$arItem["DETAIL_PAGE_URL"] ?>"><?endif;?>
											<div class="b-basket_table_photo" style="background-image:url('<?=$url?>')"></div>
										<?if (strlen($arItem["DETAIL_PAGE_URL"]) > 0):?></a><?endif;?>
									</div>
									<?
									if (!empty($arItem["BRAND"])):
									?>
									<div class="b-basket_table_brand">
								...
								<td class="item">
									<div class="b-basket_table_item-name">
										<?if (strlen($arItem["DETAIL_PAGE_URL"]) > 0):?><a href="<?=$arItem["DETAIL_PAGE_URL"] ?>"><?endif;?>
											<?=$arItem["NAME"]?>
										<?if (strlen($arItem["DETAIL_PAGE_URL"]) > 0):?></a><?endif;?>
									</div>
									<div class="b-basket_table_item-props">
										<?
										if ($bPropsColumn):
										...
										<table cellspacing="0" cellpadding="0" class="counter">
											<tr>
												<td>
													...
													?>
													<div id="basket_quantity_control" class="b-basket_quantity_control">
														<?
												...
												if (isset($arItem["MEASURE_TEXT"]) && false)
												{
													?>
	...
	<div class="b-basket_order_pay">

		<div class="b-basket_order_pay_left" id="coupons_block">
		<?
		if ($arParams["HIDE_COUPON"] != "Y")
		{
		?>
			<div class="b-basket_coupon">
				...
				<a
					class="b-basket_coupon-add"
					href="javascript:void(0)"
					onclick="enterCoupon();"
					title="<?=GetMessage('SALE_COUPON_APPLY_TITLE'); ?>">
				...
				if (!empty($arResult['COUPON_LIST']))
				{
					foreach ($arResult['COUPON_LIST'] as $oneCoupon)
					{
						...
						?><div class="b-basket_coupon"><input disabled readonly type="text" name="OLD_COUPON[]" value="<?=htmlspecialcharsbx($oneCoupon['COUPON']);?>" class="<? echo $couponClass; ?>"><span class="<? echo $couponClass; ?>" data-coupon="<? echo htmlspecialcharsbx($oneCoupon['COUPON']); ?>"></span><div class="b-basket_coupon_notes"><?
...
?>
		...
		<div class="b-basket_order_pay_right">
			<table class="b-basket_order_sum">
		...
		<div style="clear:both;"></div>
		<div class="b-basket_order_pay_center">
			...
			{
				?>
				<a href="javascript:void(0)" onclick="updateBasket();" class="g-button refresh"><?=GetMessage("SALE_REFRESH")?></a>
				<?
			}
			?>
			<a href="javascript:void(0)" onclick="checkOut();" class="g-button"><?=GetMessage("SALE_ORDER")?></a>
		</div>
	</div>
</div>
<?
