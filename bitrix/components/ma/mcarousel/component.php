...
// Без добавления в корзину, мешает вспрыващей корзине когда есть товары
...
if($arParams['USE_CAROUSEL_SCRIPT'] == 'Y')
{
	$APPLICATION->AddHeadScript('/bitrix/components/ma/mcarousel/carousel/js/owl.carousel.min.js');
}
if($arParams['USE_PHOTOGALLERY'] == 'Y')
{
	$APPLICATION->AddHeadScript('/bitrix/components/ma/mcarousel/fancybox2/jquery.fancybox.pack.js');
	$APPLICATION->SetAdditionalCSS('/bitrix/components/ma/mcarousel/fancybox2/jquery.fancybox.css');	
}
if($arParams['CAROUSEL_DISPOSITION'] == 'ver') {
	$APPLICATION->SetAdditionalCSS('/bitrix/components/ma/mcarousel/carousel/css/animate.css');	
};
if($arParams['MOUSE_WHEEL'] == 'Y') {
	$APPLICATION->AddHeadScript('/bitrix/components/ma/mcarousel/carousel/js/plugins/jquery.mousewheel.min.js');
};
?>
