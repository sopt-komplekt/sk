...
$arComponentParameters = array(
	...
	"PARAMETERS" => array(
		...
		"DISPLAY_DOP_IMG_WIDTH" => array(
			"PARENT" => "BASE",
			"NAME" => GetMessage("DISPLAY_DOP_IMG_WIDTH"),
			"TYPE" => "STRING",
			"DEFAULT" => "70",
		),
		"DISPLAY_DOP_IMG_HEIGHT" => array(
			"PARENT" => "BASE",
			"NAME" => GetMessage("DISPLAY_DOP_IMG_HEIGHT"),
			"TYPE" => "STRING",
			"DEFAULT" => "70",
		),
		"RESIZE_IMAGE_DOP" => array(
			"PARENT" => "BASE",
			"NAME" => GetMessage("RESIZE_IMAGE_DOP"),
			"TYPE" => "LIST",
			"VALUES" => array(
				"1" => GetMessage("BX_RESIZE_IMAGE_EXACT"),
				"2" => GetMessage("BX_RESIZE_IMAGE_PROPORTIONAL"),
