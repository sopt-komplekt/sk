...
?>
<div class="b-smart-filter bx-filter <?=$templateData["TEMPLATE_CLASS"]?> <?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL") echo "bx-filter-horizontal"?>">
		...
		<?foreach($arResult["ITEMS"] as $key=>$arItem)//prices
		{
			...
			if(isset($arItem["PRICE"])):
				...
				<div class="bx-filter-parameters-box bx-active">
					...
					<div class="bx-filter-parameters-box-title" onclick="smartFilter.hideFilterProps(this)"><span>Стоимость <i data-role="prop_angle" class="fa fa-angle-<?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>up<?else:?>down<?endif?>"></i></span></div>
