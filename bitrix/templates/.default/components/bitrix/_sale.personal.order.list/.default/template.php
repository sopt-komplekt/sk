...
else
{
	...
	<div class="row col-md-12 col-sm-12">
		...
		{
			?>
			<a class="sale-order-history-link g-decorated-link" href="<?=$APPLICATION->GetCurPageParam("filter_history=Y", $clearFromLink, false)?>">
				<span><?echo Loc::getMessage("SPOL_TPL_VIEW_ORDERS_HISTORY")?></span>
			</a>
			<?
		}
		if ($_REQUEST["filter_history"] == 'Y')
		{
			?>
			<a class="sale-order-history-link g-decorated-link" href="<?=$APPLICATION->GetCurPageParam("", $clearFromLink, false)?>">
				<span><?echo Loc::getMessage("SPOL_TPL_CUR_ORDERS")?></span>
			</a>
			<?
			if ($_REQUEST["show_canceled"] == 'Y')
			{
			...
			{
				?>
				<a class="sale-order-history-link g-decorated-link" href="<?=$APPLICATION->GetCurPageParam("filter_history=Y&show_canceled=Y", $clearFromLink, false)?>">
					<span><?echo Loc::getMessage("SPOL_TPL_VIEW_ORDERS_CANCELED")?></span>
				</a>
				<?
			}
		}
	...
	if (!count($arResult['ORDERS']))
	{
		?>
		<div class="row col-md-12 col-sm-12">
			<a href="<?=htmlspecialcharsbx($arParams['PATH_TO_CATALOG'])?>" class="sale-order-history-link g-decorated-link">
				<span><?=Loc::getMessage('SPOL_TPL_LINK_TO_CATALOG')?></span>
			</a>
		</div>
		<?
	}
					...
					<div class="col-md-12 sale-order-list-inner-container">
							...
							<div class="row sale-order-list-inner-row">
								...
								<div class="sale-order-list-inner-row-body">
									<div class="col-md-9 col-sm-8 col-xs-12 sale-order-list-payment">
										...
										{
											?>
											<a href="#" class="sale-order-list-change-payment g-dashed-link" id="<?= htmlspecialcharsbx($payment['ACCOUNT_NUMBER']) ?>">
												<span><?= Loc::getMessage('SPOL_TPL_CHANGE_PAY_TYPE') ?></span>
											</a>
											<?
										}
									...
									if ($payment['PAID'] === 'N' && $payment['IS_CASH'] !== 'Y')
									{
										if ($order['ORDER']['IS_ALLOW_PAY'] == 'N')
										{
											...
											<div class="col-md-3 col-sm-4 col-xs-12 sale-order-list-button-container">
												<a class="sale-order-list-button g-button g-button--small inactive-button">
										...
										elseif ($payment['NEW_WINDOW'] === 'Y')
										{
											?>
											<div class="col-md-3 col-sm-4 col-xs-12 sale-order-list-button-container">
												<a class="sale-order-list-button g-button g-button--small" target="_blank" href="<?=htmlspecialcharsbx($payment['PSA_ACTION_FILE'])?>">
													<?=Loc::getMessage('SPOL_TPL_PAY')?>
												</a>
											</div>
											<?
										...
										else
										{
											?>
											<div class="col-md-3 col-sm-4 col-xs-12 sale-order-list-button-container">
												<a class="sale-order-list-button g-button g-button--small ajax_reload" href="<?=htmlspecialcharsbx($payment['PSA_ACTION_FILE'])?>">
													<?=Loc::getMessage('SPOL_TPL_PAY')?>
												</a>
											</div>
											<?
								...
								<div class="col-lg-9 col-md-9 col-sm-10 col-xs-12 sale-order-list-inner-row-template">
									<a class="sale-order-list-cancel-payment g-decorated-link">
										<i class="fa fa-long-arrow-left"></i> <span><?=Loc::getMessage('SPOL_CANCEL_PAYMENT')?></span>
									</a>
								</div>
							</div>
							<?
						...
						<div class="row sale-order-list-inner-row">
							...
							<div class="col-md-8  col-sm-12 sale-order-list-about-container">
								<a class="sale-order-list-about-link g-decorated-link" href="<?=htmlspecialcharsbx($order["ORDER"]["URL_TO_DETAIL"])?>"><span><?=Loc::getMessage('SPOL_TPL_MORE_ON_ORDER')?></span></a>
							</div>
							<div class="col-md-2 col-sm-12 sale-order-list-repeat-container">
								<a class="sale-order-list-repeat-link g-decorated-link" href="<?=htmlspecialcharsbx($order["ORDER"]["URL_TO_COPY"])?>"><span><?=Loc::getMessage('SPOL_TPL_REPEAT_ORDER')?></span></a>
							</div>
							<div class="col-md-2 col-sm-12 sale-order-list-cancel-container">
								<a class="sale-order-list-cancel-link g-decorated-link" href="<?=htmlspecialcharsbx($order["ORDER"]["URL_TO_CANCEL"])?>"><span><?=Loc::getMessage('SPOL_TPL_CANCEL_ORDER')?></span></a>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="col-md-12 sale-order-list-inner-accomplished">
						<div class="row sale-order-list-inner-row">
							<div class="col-md-3 col-sm-12 sale-order-list-about-accomplished">
								<a class="sale-order-list-about-link g-decorated-link" href="<?=htmlspecialcharsbx($order["ORDER"]["URL_TO_DETAIL"])?>">
									<span><?=Loc::getMessage('SPOL_TPL_MORE_ON_ORDER')?></span>
								</a>
							</div>
							<div class="col-md-3 col-md-offset-6 col-sm-12 sale-order-list-repeat-accomplished">
								<a class="sale-order-list-repeat-link g-decorated-link sale-order-link-accomplished" href="<?=htmlspecialcharsbx($order["ORDER"]["URL_TO_COPY"])?>">
