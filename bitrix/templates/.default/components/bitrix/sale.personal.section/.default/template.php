...
else
{
	...
	<svg display="none">
		<symbol viewBox="0 0 23.06 20.4" id="icon-basket">
			<g>
				<g>
					<polyline points="0.5 4.22 3.49 15.12 18.82 15.12 18.45 0.5 22.56 0.5" fill="none" stroke="#ff9600" stroke-linecap="round" stroke-linejoin="round"/>
					<ellipse cx="5.35" cy="19.08" rx="0.87" ry="0.82" fill="none" stroke="#ff9600" stroke-linecap="round" stroke-linejoin="round"/>
					<ellipse cx="16.25" cy="19.08" rx="0.87" ry="0.82" fill="none" stroke="#ff9600" stroke-linecap="round" stroke-linejoin="round"/>
					<line x1="0.5" y1="4.22" x2="18.11" y2="4.22" fill="none" stroke="#ff9600" stroke-linecap="round" stroke-linejoin="round"/>
				</g>
			</g>
		</symbol>
		<symbol viewBox="0 0 20.9 19" id="icon-heart">
			<g>
				<g>
					<path d="M18.74,2.17a5.69,5.69,0,0,0-8,0l-.18.2h0l0,0,0,0h0l-.18-.2a5.69,5.69,0,0,0-8,8l.2.18h0l8.09,8.09,8.09-8.09h0l.2-.18A5.69,5.69,0,0,0,18.74,2.17Z" fill="none" stroke="#ff9600" stroke-linecap="round" stroke-linejoin="round"/>
				</g>
			</g>
		</symbol>
		...
		<symbol viewBox="0 0 92.89 108.58" id="icon-person">
			<g>
				<g>
					<path d="M67.07,23.53c0,21.4-7.25,31.75-20.63,31.75-14.75,0-20.62-12.23-20.62-31.75C25.82,10.37,33.32,2,46.44,2,59.08,2,67.07,10.8,67.07,23.53Z" fill="none" stroke="#ff9600" stroke-miterlimit="10" stroke-width="4"/>
					<path d="M33.22,59.48s-11.86,7.41-21.77,10c-8.83,2.32-9.88,14.1-9.32,23.9a4.05,4.05,0,0,0,2.1,3.35c12.55,6.77,27,9.63,42.23,9.84" fill="none" stroke="#ff9600" stroke-miterlimit="10" stroke-width="4"/>
					<path d="M59.67,59.48s11.86,7.41,21.77,10c8.83,2.32,9.88,14.1,9.32,23.9a4.05,4.05,0,0,1-2.1,3.35c-12.55,6.77-27,9.63-42.23,9.84" fill="none" stroke="#ff9600" stroke-miterlimit="10" stroke-width="4"/>
				</g>
			</g>
		</symbol>
		<symbol viewBox="0 0 60 60" id="icon-order">
			<g>
				<path d="M45,25H20c-0.552,0-1,0.447-1,1s0.448,1,1,1h25c0.552,0,1-0.447,1-1S45.552,25,45,25z" fill="#ff9600"/>
				<path d="M20,19h10c0.552,0,1-0.447,1-1s-0.448-1-1-1H20c-0.552,0-1,0.447-1,1S19.448,19,20,19z" fill="#ff9600"/>
				<path d="M45,33H20c-0.552,0-1,0.447-1,1s0.448,1,1,1h25c0.552,0,1-0.447,1-1S45.552,33,45,33z" fill="#ff9600"/>
				<path d="M45,41H20c-0.552,0-1,0.447-1,1s0.448,1,1,1h25c0.552,0,1-0.447,1-1S45.552,41,45,41z" fill="#ff9600"/>
				<path d="M45,49H20c-0.552,0-1,0.447-1,1s0.448,1,1,1h25c0.552,0,1-0.447,1-1S45.552,49,45,49z" fill="#ff9600"/>
				<path d="M49,14.586V0H6v55h5v5h43V19.586L49,14.586z M40,8.414l9,9L50.586,19H40V8.414z M8,53V2h39v10.586L39.414,5H11v48H8z
					 M13,58v-3V7h25v14h14v37H13z" fill="#ff9600"/>
			</g>
		</symbol>
	</svg>
