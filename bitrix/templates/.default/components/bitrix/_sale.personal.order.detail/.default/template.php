...
else
{
	...
	<div class="container-fluid sale-order-detail">
		...
		{
			?>
			<a class="sale-order-detail-back-to-list-link-up g-decorated-link" href="<?= htmlspecialcharsbx($arResult["URL_TO_LIST"]) ?>">
				&larr; <span><?= Loc::getMessage('SPOD_RETURN_LIST_ORDERS') ?></span>
			</a>
			<?
		}
		?>
						...
						<div class="col-md-12 col-sm-12 col-xs-12 sale-order-detail-about-order-inner-container">
							<div class="row">
								<div class="col-md-4 col-sm-6 sale-order-detail-about-order-inner-container-name">
									...
									<a class="sale-order-detail-about-order-inner-container-name-read-less g-dashed-link active">
										<span><?= Loc::getMessage('SPOD_LIST_LESS') ?></span>
									</a>
									<a class="sale-order-detail-about-order-inner-container-name-read-more g-dashed-link">
								...
								if ($arParams['GUEST_MODE'] !== 'Y')
								{
									...
									<div class="col-md-2 col-sm-6 sale-order-detail-about-order-inner-container-repeat">
										<a href="<?=$arResult["URL_TO_COPY"]?>" class="sale-order-detail-about-order-inner-container-repeat-button  g-decorated-link">
										...
										{
											?>
											<a href="<?=$arResult["URL_TO_CANCEL"]?>" class="sale-order-detail-about-order-inner-container-repeat-cancel g-decorated-link">
								...
								<ul class="sale-order-detail-about-order-inner-container-details-list">
									...
									if (strlen($arResult["USER"]["EMAIL"]) && !in_array("EMAIL", $arParams['HIDE_USER_INFO']))
									{
										...
										<li class="sale-order-detail-about-order-inner-container-list-item">
											...
											<a class="sale-order-detail-about-order-inner-container-list-item-link g-decorated-link"
											   href="mailto:<?= htmlspecialcharsbx($arResult["USER"]["EMAIL"]) ?>"><span><?= htmlspecialcharsbx($arResult["USER"]["EMAIL"]) ?></span></a>
										</li>
										<?
									}
											...
											<div class="col-md-12 col-sm-12 col-xs-12 sale-order-detail-payment-options-methods">
												<div class="row sale-order-detail-payment-options-methods-information-block">
													...
													<div class="col-md-8 col-sm-7 col-xs-10 sale-order-detail-payment-options-methods-info">
														...
														{
															?>
															<a href="#" id="<?=$payment['ACCOUNT_NUMBER']?>" class="sale-order-detail-payment-options-methods-info-change-link g-dashed-link"><span><?=Loc::getMessage('SPOD_CHANGE_PAYMENT_TYPE')?></span></a>
															<?
														}
														?>
														<?
													...
													if ($payment['PAY_SYSTEM']["IS_CASH"] !== "Y")
													{
														...
														<div class="col-md-2 col-sm-12 col-xs-12 sale-order-detail-payment-options-methods-button-container">
															...
															{
																?>
																<a class="btn-theme sale-order-detail-payment-options-methods-button-element-new-window g-button g-button--small"
																   target="_blank"
													...
													<div class="sale-order-detail-payment-inner-row-template col-md-offset-3 col-sm-offset-5 col-md-5 col-sm-10 col-xs-12">
														<a class="sale-order-list-cancel-payment g-decorated-link">
															<i class="fa fa-long-arrow-left"></i> <span><?=Loc::getMessage('SPOD_CANCEL_PAYMENT')?></span>
														</a>
													</div>
												</div>
												<?
														...
														<div>
															...
															<div class="col-md-7 col-sm-7 sale-order-detail-payment-options-methods-shipment-list">
																...
																<div class="sale-order-detail-payment-options-methods-shipment-list-item-link">
																	<a class="sale-order-detail-show-link g-dashed-link"><span><?= Loc::getMessage('SPOD_LIST_SHOW_ALL')?></span></a>
																	<a class="sale-order-detail-hide-link g-dashed-link active"><span><?= Loc::getMessage('SPOD_LIST_LESS')?></span></a>
																</div>
															</div>
															<?
																											...
																											<div class="sale-order-detail-order-item-block">
																												<div class="sale-order-detail-order-item-img-block">
																													<a href="<?=htmlspecialcharsbx($basketItem['DETAIL_PAGE_URL'])?>">
																														<?
																															...
																															{
																																$imageSrc = $this->GetFolder().'/images/no_photo@1x.png';
																															}
																														?>
																												...
																												<div class="sale-order-detail-order-item-content">
																													<div class="sale-order-detail-order-item-title">
																														<a class="g-decorated-link" href="<?=htmlspecialcharsbx($basketItem['DETAIL_PAGE_URL'])?>"><span><?=htmlspecialcharsbx($basketItem['NAME'])?></span></a>
																													</div>
																													<?
												...
												<div class="sale-order-detail-order-item-tr sale-order-detail-order-basket-info sale-order-detail-order-item-tr-first">
													<div class="sale-order-detail-order-item-td" style="min-width: 300px;">
														<div class="sale-order-detail-order-item-block">
															...
															<div class="sale-order-detail-order-item-content">
																<div class="sale-order-detail-order-item-title">
																	<a class="g-decorated-link" href="<?=$basketItem['DETAIL_PAGE_URL']?>">
		...
		{
			?>
			<a class="sale-order-detail-back-to-list-link-down g-decorated-link" href="<?= $arResult["URL_TO_LIST"] ?>">&larr; <span><?= Loc::getMessage('SPOD_RETURN_LIST_ORDERS')?></span></a>
			<?
		}
		?>
	</div>
