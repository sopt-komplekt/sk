...
<div class="bx_profile">
	...
	<form method="post" name="form1" action="<?=$APPLICATION->GetCurUri()?>" enctype="multipart/form-data" role="form">
		...
		<p class="main-profile-form-buttons-block col-sm-12">
			<button type="submit" name="save" class="btn g-button btn-themes btn-default btn-md main-profile-submit"><?=(($arResult["ID"]>0) ? Loc::getMessage("MAIN_SAVE") : Loc::getMessage("MAIN_ADD"))?></button>
