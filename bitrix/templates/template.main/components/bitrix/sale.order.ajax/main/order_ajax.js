	...
	BX.Sale.OrderAjaxComponent = {
		...
		getBlockFooter: function(node)
		{
			...
			if (!isLastNode)
			{
				buttons.push(
					BX.create('A', {
						props: {href: 'javascript:void(0)', className: 'g-button g-button--small pull-right'},
		...
		createPaySystemItem: function(item)
		{
			...
			if (this.params.SHOW_PAY_SYSTEM_LIST_NAMES == 'Y')
			{
				title = BX.create('H3', {
					...
					text: item.NAME.replace("(На основании API)"," ")
				});
			}
					...
					BX.create('DIV', {
						...
						children: [
							...
							BX.create('DIV', {
								...
								html: 'Нажимая на кнопку «' + this.params.MESS_ORDER +'», я даю своё согласие на <!--noindex--><a rel="nofollow" href="/agreement/" class="g-ajax-data" target="_blank">обработку персональных данных</a><!--/noindex-->.'
							})
						]
					})
				);
