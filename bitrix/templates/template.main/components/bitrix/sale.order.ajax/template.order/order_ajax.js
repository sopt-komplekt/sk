	...
	BX.Sale.OrderAjaxComponent = {
		...
		editBasketItemsHeader: function(basketItemsNode)
		{
			...
			var headers = [
					BX.create('DIV', {
						...
						children: [
							BX.create('DIV', {
								props: {className: 'b-soa-item-td-title accent-font'},
		...
		createPaySystemItem: function(item)
		{
			...
			if (this.params.SHOW_PAY_SYSTEM_LIST_NAMES == 'Y')
			{
				title = BX.create('H3', {
					props: {
						className: 'b-soa-pp-company-smalltitle accent-font'
					}, 
					text: item.NAME
				});
			}
		...
		createDeliveryItem: function(item)
		{
			...
			{
				title = BX.create('H3', {
					props: {className: 'b-soa-pp-company-smalltitle accent-font'},
			...
			{
				cost = BX.create('B', {
					props: {className: 'b-soa-pp-delivery-cost'},
