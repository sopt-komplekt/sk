		...
		<?foreach($arResult["PROFILES"] as $val)
		{
			...
			<tr>
				...
				<td class="sale-personal-profile-list-actions">
					<a class="sale-personal-profile-list-change-button g-decorated-link" title="<?= Loc::getMessage("SALE_DETAIL_DESCR") ?>"
						href="<?= $val["URL_TO_DETAIL"] ?>"><span><?= GetMessage("SALE_DETAIL") ?></span>
					</a>
