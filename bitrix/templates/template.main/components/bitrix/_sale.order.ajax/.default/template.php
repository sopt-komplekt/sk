...
?>
	...
	<form action="<?=POST_FORM_ACTION_URI?>" method="POST" name="ORDER_FORM" id="b-soa-order-form" enctype="multipart/form-data">
		...
		<div class="b-soa-order g-clearfix" id="b-soa-order" style="opacity: 0">
			...
			<div class="b-soa">
				...
				<div id="b-soa-auth" class="b-soa-section b-soa-auth" style="display:none">
					<div class="row b-soa-section-title-container">
						<h2 class="b-soa-section-title col-xs-8">
				...
				<? if (!isset($arParams['BASKET_POSITION']) || $arParams['BASKET_POSITION'] === 'before'): ?>
					...
					<div id="b-soa-basket" data-visited="false" class="b-soa-section b-soa-basket bx-active">
						<div class="row b-soa-section-title-container">
							...
							<div class="col-xs-4 text-right"><a href="javascript:void(0)" class="b-soa-editstep g-half-link"><?=$arParams['MESS_EDIT']?></a></div>
						</div>
						<div class="b-soa-section-content"></div>
					</div>
				<? endif ?>
				...
				<div id="b-soa-region" data-visited="false" class="b-soa-section bx-active">
					<div class="row b-soa-section-title-container">
						...
						<div class="col-xs-4 text-right"><a href="" class="b-soa-editstep g-half-link"><?=$arParams['MESS_EDIT']?></a></div>
					</div>
					<div class="b-soa-section-content"></div>
				</div>
				...
				<? if ($arParams['DELIVERY_TO_PAYSYSTEM'] === 'p2d'): ?>
					...
					<div id="b-soa-pickup" data-visited="false" class="b-soa-section" style="display:none">
						<div class="row b-soa-section-title-container">
							<h2 class="b-soa-section-title col-xs-8"></h2>
							<div class="col-xs-4 text-right"><a href="" class="b-soa-editstep g-half-link"><?=$arParams['MESS_EDIT']?></a></div>
						</div>
						<div class="b-soa-section-content"></div>
					</div>
					...
					<? if ($arParams['SHOW_TOTAL_ORDER_BUTTON'] != "Y"): ?>
						...
						<? else: ?>
							...
							<div class="b-soa-order-agreement">
								<p>
									Нажимая на кнопку «<?=$arParams['MESS_ORDER']?>», я даю своё <a rel="nofollow" href="/agreement/" class="g-ajax-data" target="_blank">согласие</a> на обработку персональных данных
								</p>
							</div>
							<!--/noindex--> 
						<? endif; ?>

						<a href="javascript:void(0)" class="g-button g-button--accent hidden-xs" data-save-button="true">
							<?=$arParams['MESS_ORDER']?>
						</a>
			...
			<? /*	SIDEBAR BLOCK	*/ ?>
			<div class="b-soa-sidebar" id="b-soa-total">
