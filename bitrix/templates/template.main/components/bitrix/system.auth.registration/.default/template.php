...
<div class="b-authform">
	...
	<? else: ?>
		...
		<? endif; ?>
			...
			<?/*
			<div class="b-authform__description">
				<?echo GetMessage("AUTH_PHONE_DESC");?>
			</div>

			<div class="b-authform__item">
				<label class="b-authform__label" for="i-auth-user-phone">
					<?=GetMessage("AUTH_PHONE")?>
					<span class="b-authform__starrequired">*</span>
				</label>
				<div class="b-authform__field">
					<input type="text" name="USER_PERSONAL_PHONE" id="i-auth-user-phone" value="<?=$arResult["PERSONAL_PHONE"]?>">
				</div>
			</div>
			*/?>
			...
			<div class="b-authform__item b-authform__submit">
				<button type="submit" class="g-button" name="Register" value="y"><?=GetMessage("AUTH_REGISTER")?></button>
			</div>
