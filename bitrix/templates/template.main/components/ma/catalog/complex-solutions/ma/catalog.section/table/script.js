...
/*$(document).ready(function() {
	var btn = $("a[id^='catalog_add2cart_link']");
...
BX.ready(function()
{
	var nodeAdd2BasketList = document.querySelectorAll('a[id^="catalog_add2cart_link"]');
	[].forEach.call(nodeAdd2BasketList, function(nodeAdd2Basket){
		BX.bind(BX(nodeAdd2Basket), 'click', function()
		{
