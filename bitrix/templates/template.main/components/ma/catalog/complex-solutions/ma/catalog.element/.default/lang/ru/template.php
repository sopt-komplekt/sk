...
$MESS ['CATALOG_IN_BASKET'] = "В корзине";
...
$MESS ['CATALOG_FAVORITE'] = "В избранное";
...
$MESS ['CATALOG_AVAILABLE'] = "Есть в наличии (остаток на складе:";
$MESS['OLD_PRICE'] = 'Старая цена: ';
$MESS['MAIN_TAB'] = 'Описание';
$MESS['COMMENTS_TAB'] = 'Отзывы';
$MESS['GIFT_ELEMENTS'] = 'Товары в подарок';
$MESS['GIFT_ELEMENTS_TEXT_1'] = 'Получите эти позиции бесплатно при покупке «';
$MESS['GIFT_ELEMENTS_TEXT_2'] = '»:';

$MESS['NOT_PRICE'] = 'Цену уточняйте';
?>