			...
			<div class="b-products-table__info">
				...
				<? if (!isset($arItem['OFFERS']) || empty($arItem['OFFERS'])): ?>
					<? if (isset($arItem['DISPLAY_PROPERTIES']) && !empty($arItem['DISPLAY_PROPERTIES'])): ?>
						<div class="b-products-table__articul">
							<? foreach ($arItem['DISPLAY_PROPERTIES'] as $arOneProp): ?>
								<div class="b-products-table__articul-item">
									<b><?=$arOneProp['NAME']; ?>:</b>
									<?  echo (
						...
						<? if($arItem['CAN_BUY'] && $arItem["CATALOG_QUANTITY"] > 0): ?>
							...
							*/ ?>
							<div id="<?=$arItemIDs['BASKET_ACTIONS']; ?>" class="b-catalog-sections_item_controls_basket">
								<a class="b-products-table__button b-products-table__basket g-button g-button--small g-ajax-data" href="<?=$arItem["ADD_TO_BASKET_URL"]?>" id="catalog_add2cart_link_<?=$arItem['ID']?>" rel="nofollow">
									<? echo $arParams['ADD_TO_BASKET_ACTION'] == 'BUY' ? GetMessage('CT_BCS_TPL_MESS_BTN_BUY') : GetMessage('CT_BCS_TPL_MESS_BTN_ADD_TO_BASKET');?>
								</a>
							</div> 
						<? elseif ($arItem['CAN_BUY'] && $arItem["CATALOG_QUANTITY"] < 1): ?>
							<div class="b-catalog-list_item_controls_notavailable can-buy" id="<?=$arItemIDs['NOT_AVAILABLE_MESS'];?>">
							...
							<div id="<?=$arItemIDs['BASKET_ACTIONS']; ?>" class="b-catalog-sections_item_controls_basket">
								<a class="b-products-table__button b-products-table__basket g-button g-button--small g-ajax-data" href="<?=$arItem["ADD_TO_BASKET_URL"]?>" id="catalog_add2cart_link_<?=$arItem['ID']?>" rel="nofollow">
									<? echo $arParams['ADD_TO_BASKET_ACTION'] == 'BUY' ? GetMessage('CT_BCS_TPL_MESS_BTN_BUY') : GetMessage('CT_BCS_TPL_MESS_BTN_ORDERING');?>
								</a>
							</div> 
						<? else: ?>
