...
<div class="l-wrapper b-product-search">
	<?$APPLICATION->IncludeComponent(
		...
		array(
			...
			"SECTION_URL" => $arResult["FOLDER"].$arResult["URL_TEMPLATES"]["section"], //$arParams["SECTION_URL"],
			...
			"ELEMENT_LIST_TEMPLATE" => $arParams['ELEMENT_LIST_TEMPLATE'],
		),
		$component,
		array("HIDE_ICONS" => "Y")
	);
